...
for i_SNR = 1:length(SNRdBs)
    ...
    for i_packet = 1:N_packet
        ...
        %channel
        H = zeros(2,2); % RX antenal channel
        
        if strcmp(channel,'rayleigh')
            H = (randn(2,2)+ 1i*randn(2,2))/sq2;
        ...
        %noise = signma*awgnH
        N = sigma*(randn(4,1)+randn(4,1)*1i);
        N11 = N(1,1);
        N12 = N(2,1);
        N21 = N(3,1);
        N22 = N(4,1);
        ...
        N21_conj = conj(N21);
        N22_conj = conj(N22);
        N_new = [N11;N12;N21_conj;N22_conj];
        ...
        H_new = [H11 H12; H21 H22; H12_conj -H11_conj; H22_conj -H21_conj ];
